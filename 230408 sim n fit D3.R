...
P <- (1/.3556) / c(rep(15,2), rep(15*2,2), rep(15*3,7))
breaks <- cumsum(round(P*n))[1:10]
...
for (j in 1:n_sim){
  ...
  for (i in seq_along(p2)) {
    ...
    row_indices <- c(col_value, col_value + 2, col_value + 4) # D3
...
setwd("C:/Users/nuria/OneDrive/Escritorio/Universidad/TFM-Paper/Sim v4/Results D3")

saveRDS(BLCS.fit, paste0("BLCS.fit_D3_",n,".rds"))                                     #!#
...
setwd("C:/Users/nuria/OneDrive/Escritorio/Universidad/TFM-Paper/Sim v4/Results D3")
saveRDS(summaries, paste0("summaries_D3_",n,".rds"))                                   #!#
